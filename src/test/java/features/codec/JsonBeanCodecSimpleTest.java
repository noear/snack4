...
public class JsonBeanCodecSimpleTest {
    ...
    public void testSimpleBean() {
        ...
        ONode node = BeanEncoder.serialize(bean);
        SimpleBean result = BeanDecoder.deserialize(node, SimpleBean.class);
    ...
    public void testNestedBean() {
        ...
        ONode node = BeanEncoder.serialize(bean);
        NestBean result = BeanDecoder.deserialize(node, NestBean.class);
    ...
    public void testStringList() {
        ...
        ONode node = BeanEncoder.serialize(bean);
        ListBean result = BeanDecoder.deserialize(node, ListBean.class);
    ...
    public void testStringIntMap() {
        ...
        ONode node = BeanEncoder.serialize(bean);
        MapBean result = BeanDecoder.deserialize(node, MapBean.class);
    ...
    public void testEnumConversion() {
        ...
        EnumBean result = BeanDecoder.deserialize(node, EnumBean.class);
    ...
    public void testEmptyCollections() {
        ...
        ONode node = BeanEncoder.serialize(bean);
        EmptyCollectionBean result = BeanDecoder.deserialize(node, EmptyCollectionBean.class);
    ...
    public void testInheritedFields() {
        ...
        ONode node = BeanEncoder.serialize(bean);
        ChildBean result = BeanDecoder.deserialize(node, ChildBean.class);
    ...
    public void testPrimitiveDefaults() {
        ...
        PrimitiveBean result = BeanDecoder.deserialize(emptyNode, PrimitiveBean.class);
    ...
    public void testGenericList() {
        ...
        ONode node = BeanEncoder.serialize(bean);
        GenericListBean result = BeanDecoder.deserialize(node, GenericListBean.class);
    ...
    public void testTypeMismatch() {
        ...
        assertThrows(RuntimeException.class, () -> {
            BeanDecoder.deserialize(node, SimpleBean.class);
        });
    }
    ...
    public void testDifferentAccessFields() {
        ...
        ONode node = BeanEncoder.serialize(bean);
        AccessBean result = BeanDecoder.deserialize(node, AccessBean.class);
    ...
    public void testBooleanTypes() {
        ...
        ONode node = BeanEncoder.serialize(bean);
        BooleanBean result = BeanDecoder.deserialize(node, BooleanBean.class);
    ...
    public void testEnumCaseSensitive() {
        ...
        assertThrows(IllegalArgumentException.class, () -> {
            BeanDecoder.deserialize(node, EnumBean.class); // 需要 "ERROR" 大写
        });
    }
    ...
    public void testNumberConversion() {
        ...
        NumberBean result = BeanDecoder.deserialize(node, NumberBean.class);
    ...
    public void testPolymorphicList() {
        ...
        ONode node = BeanEncoder.serialize(bean);
        assertDoesNotThrow(() -> BeanDecoder.deserialize(node, PolyBean.class));
    }
