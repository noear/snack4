...
public class JsonPathTest4 {
    ...
    public void test1() {
        ...
        String jsonPath = "$..*[?(@.id)]";
        String json1 = ONode.loadJson(test).select(jsonPath).toJson();
        System.out.println("org.noear.snack: " + json1);

        Object documentContext = JsonPath.read(test, jsonPath);
        String json2 = ONode.loadBean(documentContext).toJson();
    ...
    public void test9_2() {
        ...
        System.out.println(ONode.loadJson(json).select("request1.result[*].relTickers.first()"));
    ...
    public void test10_1() {
        ...
        ONode oNode = ONode.loadJson(json).select("$.result[*].amount.sum()");
    ...
    public void test10_2() {
        ...
        ONode oNode = ONode.loadJson(json).select("$.result[*].amount.min()");
        System.out.println(oNode.toString());
