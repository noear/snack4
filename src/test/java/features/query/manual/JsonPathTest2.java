...
public class JsonPathTest2 {
    ...
    public void test1() {
        ...
        Map<String, Object> t7 = n.select("$..book[2]").toBean(Map.class);
    ...
    public void test4() {
        ...
        ONode oNode = ONode.loadJson(str);
    ...
    @Test
    public void test6() {
        ONode oNode = ONode.loadJson("{\"data\":{\"title\":{\"updatedTime\":1648799928406,\"schemaType\":\"i\",\"name\":\"testName\"}}}");
    ...
    @Test
    public void test7(){
        ONode oNode = ONode.loadJson("{\"data\":[{\"name\":false,\"value\":1},{\"name\":false,\"value\":2},{\"name\":false,\"value\":3},{\"name\":false,\"value\":4}]}");
